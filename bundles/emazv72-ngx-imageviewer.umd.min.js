!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("@angular/core"),require("rxjs"),require("@angular/platform-browser")):"function"==typeof define&&define.amd?define("@emazv72/ngx-imageviewer",["exports","@angular/core","rxjs","@angular/platform-browser"],e):e(((t="undefined"!=typeof globalThis?globalThis:t||self).emazv72=t.emazv72||{},t.emazv72["ngx-imageviewer"]={}),t.ng.core,t.rxjs,t.ng.platformBrowser)}(this,(function(t,e,o,i){"use strict";var n=function(){};function r(t,e,o,i){return void 0===o&&(o=0),void 0===i&&(i=!0),{icon:t,tooltip:e,sortId:o,show:i}}var s=new e.InjectionToken("imageviewer.config"),a={width:800,height:600,bgStyle:"#ECEFF1",scaleStep:.1,rotateStepper:!1,loadingMessage:"Loading...",buttonStyle:{iconFontFamily:"Material Icons",alpha:.5,hoverAlpha:.7,bgStyle:"#000000",iconStyle:"#ffffff",borderStyle:"#000000",borderWidth:0},tooltips:{enabled:!0,bgStyle:"#000000",bgAlpha:.5,textStyle:"#ffffff",textAlpha:.9,padding:15,radius:20},nextPageButton:r(String.fromCharCode(58377),"Next page",0),beforePageButton:r(String.fromCharCode(58376),"Previous page",1),zoomOutButton:r(String.fromCharCode(59648),"Zoom out",0),zoomInButton:r(String.fromCharCode(59647),"Zoom in",1),rotateLeftButton:r(String.fromCharCode(58393),"Rotate left",2),rotateRightButton:r(String.fromCharCode(58394),"Rotate right",3),resetButton:r(String.fromCharCode(59491),"Reset",4)},h=function(){function t(t,e){this.style=e,this.sortId=0,this.hover=!1,this.display=!0,this.drawPosition=null,this.drawRadius=0,this.sortId=t.sortId,this.display=t.show,this.icon=t.icon,this.tooltip=t.tooltip}return t.prototype.onClick=function(t){return alert("no click action set!"),!0},t.prototype.onMouseDown=function(t){return!1},t.prototype.draw=function(t,e,o,i){this.drawPosition={x:e,y:o},this.drawRadius=i,t.save();var n="function"==typeof this.hover?this.hover():this.hover;t.globalAlpha=n?this.style.hoverAlpha:this.style.alpha,t.fillStyle=this.style.bgStyle,t.lineWidth=0,t.beginPath(),t.arc(e,o,i,0,2*Math.PI),t.closePath(),t.fill(),this.style.borderWidth>0&&(t.lineWidth=this.style.borderWidth,t.strokeStyle=this.style.borderStyle,t.stroke()),null!==this.icon&&(t.save(),this.drawIconFont(t,e,o,i),t.restore()),t.restore()},t.prototype.drawIconFont=function(t,e,o,i){t.font=i+"px "+this.style.iconFontFamily,t.fillStyle=this.style.iconStyle;var n=e-t.measureText(this.icon).width/2,r=o+i/2;t.fillText(this.icon,n,r)},t.prototype.isWithinBounds=function(t,e){if(null===this.drawPosition)return!1;var o=Math.abs(this.drawPosition.x-t),i=Math.abs(this.drawPosition.y-e);return o*o+i*i<=this.drawRadius*this.drawRadius},t}(),c=function(){function t(){this.viewport={width:0,height:0,scale:1,rotation:0,x:0,y:0},this.minScale=0,this.maxScale=4,this.currentItem=1,this.totalItem=1,this.showItemsQuantity=!1,this.loaded=!1,this.loading=!1,this.rendering=!1,this.resourceChange=new o.Subject}return t.prototype.resetViewport=function(t){if(this.loaded&&t){var e=u(this.viewport?this.viewport.rotation:0)/90%2!=0,o=e?t.height:t.width,i=e?t.width:t.height;i/this._image.height*this._image.width<=o?this.viewport.scale=i/this._image.height:this.viewport.scale=o/this._image.width,this.minScale=this.viewport.scale/4,this.maxScale=4*this.viewport.scale,this.viewport.width=this._image.width*this.viewport.scale,this.viewport.height=this._image.height*this.viewport.scale,this.viewport.x=(t.width-this.viewport.width)/2,this.viewport.y=(t.height-this.viewport.height)/2}},t.prototype.draw=function(t,e,o,i){t.clearRect(0,0,o.width,o.height),t.fillStyle=e.bgStyle,t.fillRect(0,0,o.width,o.height),!this.loading&&this.loaded?(t.translate(this.viewport.x+this.viewport.width/2,this.viewport.y+this.viewport.height/2),t.rotate(this.viewport.rotation*Math.PI/180),t.scale(this.viewport.scale,this.viewport.scale),t.drawImage(this._image,-this._image.width/2,-this._image.height/2)):(t.fillStyle="#333",t.font="25px Verdana",t.textAlign="center",t.fillText(e.loadingMessage||"Loading...",o.width/2,o.height/2)),i(t,e,o)},t.prototype.onResourceChange=function(){return this.resourceChange.asObservable()},t}();function u(t){return(Math.trunc(t/90)+(Math.trunc(t%90)>45?1:0))%4*90}
/*! *****************************************************************************
